  ...
  return (
    <>
      ...
      <div className="website-section-container">
        ...
        <div className="about-section-shortcut">
          <a href="#about">
            <FaUser />
          </a>
          <div className="tool-tip">about me</div>
        </div>
        <div className="services-section-shortcut">
          <a href="#services">
            <FaServicestack />
          </a>
          <div className="tool-tip">services what i do</div>
        </div>
        <div className="certificate-section-shortcut">
          <a href="#certificate">
            <FaCheckCircle />
          </a>
          <div className="tool-tip">certificate i have</div>
        </div>
        <div className="portfolio-section-shortcut">
          <a href="#portfolio">
            <FaFile />
          </a>
          <div className="tool-tip">portfolio</div>
        </div>
        {/* <div className="clients-section-shortcut">
          <a href="#clients">
            <FaUser />
          </a>
          ...
          <div className="container">
            <div className="row">
              <div className="col-12" data-aos="fade-up">
                <h1 data-aos="fade-in">Hello Iam Mohamed</h1>
                <p data-aos="fade-in">Iam FullStack Developer</p>
                <div className="btns-container">
                  <button data-aos="fade-in">Portfolio</button>
                  <button data-aos="fade-in">Get In Touch</button>
                </div>
              </div>
            </div>
          </div>
